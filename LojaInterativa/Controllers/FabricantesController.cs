...
namespace LojaInterativa.Controllers
{
    public class FabricantesController : Controller
    {
        ...
        public FabricantesController(LojaInterativaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Fabricante != null ? 
                          ...
                          Problem("Entity set 'LojaInterativaContext.Fabricante'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Data")] Fabricante fabricante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Data")] Fabricante fabricante)
        {
            if (id != fabricante.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LojaInterativaContext.Fabricante'  is null.");
            }
            var fabricante = await _context.Fabricante.FindAsync(id);
            if (fabricante != null)
            {
